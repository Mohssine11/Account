        ...
        <form method="POST" action="{{ route('register.store') }}" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" required autocomplete="name" placeholder="أدخل اسمك الكامل"
                        maxlength="50">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" required autocomplete="new-password"
                        placeholder="********" minlength="6" maxlength="30">
                </div>
                <div class="form-group">
                    <label for="password_confirmation">تأكيد كلمة المرور</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" required
                        autocomplete="new-password" placeholder="********" minlength="6" maxlength="30">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label for="solde">الرصيد الابتدائي</label>
                    <input type="number" id="solde" name="solde" min="0" required placeholder="0" step="0.01"
                        max="1000000">
                </div>
                <div class="form-group">
